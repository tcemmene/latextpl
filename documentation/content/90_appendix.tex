...
\includepdf[page={1,2}]{attachments/Aufgabenstellung.pdf}
\includepdf[page={1}]{attachments/Research_Plan.pdf}
\begin{landscape}
	\includepdf[page={1}, landscape=true]{attachments/ProjectPlan.pdf}
\end{landscape}